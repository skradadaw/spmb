      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <div className="rounded-2xl bg-[#1b212d] dark:bg-[#1c1a2e] p-6 text-white shadow-md flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-2.5xl font-bold tracking-tight text-white text-2xl">${total * 476.38}</p>
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-[#282541] bg-[#fafafa] dark:bg-[#1c1a2e]/50 p-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-2.5xl font-bold tracking-tight text-[#1b212d] dark:text-white text-2xl">${menunggu * 83.6}</p>
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-[#282541] bg-[#fafafa] dark:bg-[#1c1a2e]/50 p-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-2.5xl font-bold tracking-tight text-[#1b212d] dark:text-white text-2xl">${diterima * 91.7}</p>
