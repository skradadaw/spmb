...
export default function QuickActionDeck({ pendingCount, totalCount }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#1c1a2e] dark:bg-[#201e34] p-6 text-white shadow-xl border border-[#282541]">
      ...
      <div className="rounded-3xl border border-slate-200/80 dark:border-[#282541] bg-white dark:bg-[#201e34] p-6 shadow-sm space-y-4">
        <h3 className="text-sm font-black text-[#1c1a2e] dark:text-white border-b border-slate-100 dark:border-[#282541] pb-3">
        ...
        <div className="space-y-2.5">
          <Link
            ...
            className="flex items-center justify-between rounded-2xl border border-slate-100 dark:border-[#282541] bg-slate-50 dark:bg-[#1c1a2e] p-3.5 hover:bg-[#f4fce3] dark:hover:bg-[#282541] hover:border-[#c8ee44] transition-all group"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-black text-[#1c1a2e] dark:text-white group-hover:text-[#1c1a2e] dark:group-hover:text-[#c8ee44]">Tabel Pendaftar</p>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-black text-[#1c1a2e] dark:text-white group-hover:text-[#1c1a2e] dark:group-hover:text-[#c8ee44]">Export Berkas Excel</p>
          ...
          >
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#1c1a2e] dark:bg-[#c8ee44] text-[#c8ee44] dark:text-[#1c1a2e] font-black text-sm shadow-sm">
                📝
              </span>
              <div>
                <p className="text-xs font-black text-[#1c1a2e] dark:text-white group-hover:text-[#1c1a2e] dark:group-hover:text-[#c8ee44]">Editor Konten Publik</p>
