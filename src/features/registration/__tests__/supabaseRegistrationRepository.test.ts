...
const registrationData: RegistrationData = {
  ...
  unitSaudaraDirektorat2: 'SMP Fullday Al-Muhajirin',
    ...
    expect(spies.insert).toHaveBeenCalledWith([
      {
        ...
        nama_orangtua_direktorat2: 'Budi Santoso',
        unit_orangtua_direktorat2: 'SD Plus 3 Al-Muhajirin',
        saudara_di_direktorat2: 'Ya',
        nama_saudara_direktorat2: 'Ahmad Santoso',
        unit_saudara_direktorat2: 'SMP Fullday Al-Muhajirin',
